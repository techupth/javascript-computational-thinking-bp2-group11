...
{ if(orders[x].customerName === "Birdie Shepland"){
  totalAmount = totalAmount + (
  orders[x].productPrice * orders[x].productQuantity)
}
  
};

console.log(`Total paid amount of Birdie Shepland: (${totalAmount}) Bath`);
