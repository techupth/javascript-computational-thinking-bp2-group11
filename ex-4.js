...
{
if(maxPrice < orders[x].productPrice)
{
maxPrice = orders[x].productPrice;
maxPriceName = orders[x].productName;
}
};
console.log(`The most expensive product in orders: ${maxPriceName}`);
